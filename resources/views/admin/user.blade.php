                ...
                <form id="form-data">
                    ...
                    <div class="form-group">
                        <div class="alert alert-teal text-center">
                            Password default user yang baru ditambahkan adalah <b>123456</b>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function createData() {
        $.ajax({
            url: '{{ url("admin/user/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("admin/user/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("admin/user/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id

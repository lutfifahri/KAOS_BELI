<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                <span class="fw-normal">Produk</span>
            </h5>
        </div>
            ...
            <div class="modal-body">
                ...
                <form id="form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Percetakan <span class="text-danger fw-bold">*</span></label>
                        <div class="col-md-9">
                            <select class="form-select select2-basic" name="printing_id" id="printing_id">
                                <option value="">-- Pilih --</option>
                                @foreach($printing as $p)
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Kategori <span class="text-danger fw-bold">*</span></label>
                        <div class="col-md-9">
                            <select class="form-select select2-basic" name="category_id" id="category_id">
                                <option value="">-- Pilih --</option>
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            columns: [
                ...
                { data: 'printing_name', name: 'printing_name', orderable: false, searchable: true, className: 'align-middle' },
                { data: 'category_name', name: 'category_name', orderable: false, searchable: true, className: 'align-middle' },
                { data: 'price', name: 'price', orderable: true, searchable: true, className: 'align-middle' },
    ...
    function createData() {
        $.ajax({
            url: '{{ url("admin/product/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("admin/product/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(response) {
                ...
                $('#printing_id').val(response.printing_id).change();
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("admin/product/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("admin/product/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id

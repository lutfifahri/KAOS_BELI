<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                <span class="fw-normal">Percetakan</span>
            </h5>
        </div>
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("admin/printing/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
    ...
    function createData() {
        $.ajax({
            url: '{{ url("admin/printing/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("admin/printing/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("admin/printing/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("admin/printing/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id

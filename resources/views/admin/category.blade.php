<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                <span class="fw-normal">Kategori</span>
            </h5>
        </div>
...
<script>
    ...
    function createData() {
        $.ajax({
            url: '{{ url("admin/category/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("admin/category/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("admin/category/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: new FormData($('#form-data')[0]),
            contentType: false,
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("admin/category/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
